    ...
    def record_bar(
        ...
        if snap:
            indic = {
                ...
                "ema_ribbon_high_1h": _dec(snap.ema_ribbon_high_1h),
                "ema_ribbon_center_1h": _dec(snap.ema_ribbon_center_1h),
                "ema_ribbon_width_1h_atr": round(snap.ema_ribbon_width_1h_atr, 4) if snap.ema_ribbon_width_1h_atr is not None else None,
                "ema9_21_distance_1h_atr": round(snap.ema9_21_distance_1h_atr, 4) if snap.ema9_21_distance_1h_atr is not None else None,
                "ema21_50_distance_1h_atr": round(snap.ema21_50_distance_1h_atr, 4) if snap.ema21_50_distance_1h_atr is not None else None,
                "ema9_50_distance_1h_atr": round(snap.ema9_50_distance_1h_atr, 4) if snap.ema9_50_distance_1h_atr is not None else None,
                "ema_stack_direction_1h": snap.ema_stack_direction_1h,
                "ema_slope_alignment_1h": snap.ema_slope_alignment_1h,
                # ── H1-sealed price location ───────────────────────────────────
                "h1_close_location_vs_ema_ribbon_1h": snap.h1_close_location_vs_ema_ribbon_1h,
                "h1_close_to_ema_ribbon_1h_atr": round(snap.h1_close_to_ema_ribbon_1h_atr, 4) if snap.h1_close_to_ema_ribbon_1h_atr is not None else None,
                "h1_close_to_ema_ribbon_center_1h_atr": round(snap.h1_close_to_ema_ribbon_center_1h_atr, 4) if snap.h1_close_to_ema_ribbon_center_1h_atr is not None else None,
                # ── M1-close live location ─────────────────────────────────────
                "m1_close_location_vs_ema_ribbon_1h": snap.m1_close_location_vs_ema_ribbon_1h,
                "m1_close_to_ema_ribbon_1h_atr": round(snap.m1_close_to_ema_ribbon_1h_atr, 4) if snap.m1_close_to_ema_ribbon_1h_atr is not None else None,
                "m1_close_to_ema_ribbon_center_1h_atr": round(snap.m1_close_to_ema_ribbon_center_1h_atr, 4) if snap.m1_close_to_ema_ribbon_center_1h_atr is not None else None,
                # ── SMA200 structural context ──────────────────────────────────
                "ema_ribbon_center_to_sma200_1h_atr": round(snap.ema_ribbon_center_to_sma200_1h_atr, 4) if snap.ema_ribbon_center_to_sma200_1h_atr is not None else None,
                "price_to_sma200_1h_atr": round(snap.price_to_sma200_1h_atr, 4) if snap.price_to_sma200_1h_atr is not None else None,
                # ── Rolling ribbon fields ──────────────────────────────────────
                "ema_ribbon_width_percentile_60h": round(snap.ema_ribbon_width_percentile_60h, 1) if snap.ema_ribbon_width_percentile_60h is not None else None,
                "ema_ribbon_width_slope_3h": round(snap.ema_ribbon_width_slope_3h, 6) if snap.ema_ribbon_width_slope_3h is not None else None,
                "ema_ribbon_width_slope_6h": round(snap.ema_ribbon_width_slope_6h, 6) if snap.ema_ribbon_width_slope_6h is not None else None,
                "ema_bullish_stack_persistence_1h_bars": snap.ema_bullish_stack_persistence_1h_bars,
                "ema_bearish_stack_persistence_1h_bars": snap.ema_bearish_stack_persistence_1h_bars,
                "price_inside_ribbon_persistence_1h_bars": snap.price_inside_ribbon_persistence_1h_bars,
                "price_ribbon_location_transition_count_6h": snap.price_ribbon_location_transition_count_6h,
                "price_ribbon_full_cross_count_6h": snap.price_ribbon_full_cross_count_6h,
                "ema_ribbon_width_state_1h": snap.ema_ribbon_width_state_1h,
                # ── Derived ribbon contexts ────────────────────────────────────
                "bullish_ema_ribbon_context_1h": snap.bullish_ema_ribbon_context_1h,
                "bearish_ema_ribbon_context_1h": snap.bearish_ema_ribbon_context_1h,
                "chop_ema_ribbon_context_1h": snap.chop_ema_ribbon_context_1h,
                "htf_1h_watermark": snap.htf_1h_watermark.isoformat() if snap.htf_1h_watermark is not None else None,
                "ema10_1d": _dec(snap.ema10_1d),
                "ema20_1d": _dec(snap.ema20_1d),
                "atr14": _dec(snap.atr_14),
                "session_phase": str(snap.session_phase),
                "or_high": _dec(snap.or_high),
                "or_low": _dec(snap.or_low),
                ...
                # ── EMA acceleration ───────────────────────────────────────────
                "ema9_1m_slope_accel": round(snap.ema9_1m_slope_accel_norm, 6) if snap.ema9_1m_slope_accel_norm is not None else None,
                "ema21_1m_slope_accel": round(snap.ema21_1m_slope_accel_norm, 6) if snap.ema21_1m_slope_accel_norm is not None else None,
                "ema9_5m_slope_accel": round(snap.ema9_5m_slope_accel_norm, 6) if snap.ema9_5m_slope_accel_norm is not None else None,
                "ema21_5m_slope_accel": round(snap.ema21_5m_slope_accel_norm, 6) if snap.ema21_5m_slope_accel_norm is not None else None,
                # ── EMA MTF composite ──────────────────────────────────────────
                "ema_bearish_alignment_1m": snap.ema_bearish_alignment_1m,
                "ema_bearish_alignment_5m": snap.ema_bearish_alignment_5m,
                "ema_mtf_all_bearish": snap.ema_mtf_all_bearish,
                "ema_mtf_all_bullish": snap.ema_mtf_all_bullish,
                "ema_mtf_strength": round(snap.ema_mtf_strength, 6) if snap.ema_mtf_strength is not None else None,
                "ema_slope_dispersion": round(snap.ema_slope_dispersion, 6) if snap.ema_slope_dispersion is not None else None,
                "ema_bearish_persistence_bars": snap.ema_bearish_persistence_bars,
                "ema_bullish_persistence_bars": snap.ema_bullish_persistence_bars,
                # ── VWAP point-in-time geometry ────────────────────────────────
                "vwap_relative_side": snap.vwap_relative_side,
                "bar_high_distance_to_vwap_atr": round(snap.bar_high_distance_to_vwap_atr, 4) if snap.bar_high_distance_to_vwap_atr is not None else None,
                "bar_low_distance_to_vwap_atr": round(snap.bar_low_distance_to_vwap_atr, 4) if snap.bar_low_distance_to_vwap_atr is not None else None,
                "vwap_approach_velocity_atr": round(snap.vwap_approach_velocity_atr, 6) if snap.vwap_approach_velocity_atr is not None else None,
                # ── Candle geometry ────────────────────────────────────────────
                "bar_body_pct": round(snap.bar_body_pct, 4) if snap.bar_body_pct is not None else None,
                "upper_wick_pct": round(snap.upper_wick_pct, 4) if snap.upper_wick_pct is not None else None,
                "lower_wick_pct": round(snap.lower_wick_pct, 4) if snap.lower_wick_pct is not None else None,
                "bar_range_atr": round(snap.bar_range_atr, 4) if snap.bar_range_atr is not None else None,
                "is_inside_bar": snap.is_inside_bar,
                "is_outside_bar": snap.is_outside_bar,
            }
    ...
    def save(
        ...
        if snap_final:
            final_snap = {
                ...
                "or_high": _dec(snap_final.or_high),
                "or_low": _dec(snap_final.or_low),
            }
