    ...
    def record_bar(
        ...
        if snap:
            indic = {
                ...
                "ema_mtf_bearish_strength": round(snap.ema_mtf_bearish_strength, 6) if snap.ema_mtf_bearish_strength is not None else None,
                "ema_mtf_bullish_strength": round(snap.ema_mtf_bullish_strength, 6) if snap.ema_mtf_bullish_strength is not None else None,
                ...
                # ── VWAP approach ──────────────────────────────────────────────
                "vwap_approach_direction": snap.vwap_approach_direction,
                ...
                "vwap_approach_persistence_bars": snap.vwap_approach_persistence_bars,
                "vwap_test_from_below": snap.vwap_test_from_below,
                "vwap_test_from_above": snap.vwap_test_from_above,
                "bars_below_vwap_before_test": snap.bars_below_vwap_before_test,
                "bars_above_vwap_before_test": snap.bars_above_vwap_before_test,
                # ── Candle geometry ────────────────────────────────────────────
